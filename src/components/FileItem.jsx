...
const isImage = (file) => {
    return ["jpg", "jpeg", "png", "gif", "bmp", "webp", "svg"].includes(file.typeFile.toLowerCase());
};
        ...
        <div className="bg-blue-100 p-3 rounded-lg flex items-center justify-between w-80 mb-2">
            <div className="flex items-center">
                ...
                <div>
                    ...
                    <p className="text-xs text-gray-500">{convertTime(file.sentDate)}</p>
                </div>
            </div>
            <a href={file.fileUrl} download className="text-blue-500 text-lg">
                <FaDownload />
            </a>
        </div>
    );
