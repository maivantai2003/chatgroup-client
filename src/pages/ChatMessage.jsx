              ...
              <div className="flex items-center">
                ...
                <div className="ml-2">
                  <div className="font-bold">
                    New Release win-3.0.504
                  </div>
                  <div className="text-sm">3.0.504</div>
                </div>
              </div>
              <div className="mt-2 text-sm text-gray-600">
                This is a critical bug fix release for Redis on Windows
                3.0. If you are running a previous version of 3.0 in a
                cluster configuration, you should upgrade to 3.0.504
                urgently...
              </div>
